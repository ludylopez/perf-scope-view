  ...
  dimensionesDesempeno: [
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso
      items: [
...
export const INSTRUMENT_O2: Instrument = {
  ...
  dimensionesDesempeno: [
    ...
    },
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso (ajustado para sumar exactamente 1.0)
      items: [
  ...
  dimensionesPotencial: [
    {
      ...
      peso: 0.2, // 1/5 - Todas las dimensiones de potencial tienen el mismo peso (A4 tiene 5 dimensiones de potencial)
      items: [
...
export const INSTRUMENT_S2: Instrument = {
  ...
  dimensionesPotencial: [
    ...
    },
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso // 20/100
      items: [
...
export const INSTRUMENT_D2: Instrument = {
  ...
  dimensionesDesempeno: [
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso // 20%
      items: [
    ...
    },
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso // 15%
      items: [
    ...
    },
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso // 10%
      items: [
  ...
  dimensionesPotencial: [
    ...
    },
    {
      ...
      peso: 0.16667, // 1/6 - Todas las dimensiones tienen el mismo peso // 2/10
      items: [
...
export const INSTRUMENT_C1: Instrument = {
  ...
  dimensionesDesempeno: [
    {
      ...
      peso: 0.125, // 1/8 - Todas las dimensiones tienen el mismo peso (C1 tiene 8 dimensiones)
      items: [
  ...
  // IMPORTANTE: C1 NO tiene dimensiones de potencial (solo autoevaluación de desempeño)
  dimensionesPotencial: [],
  configuracion_calculo: {
    pesoAuto: 1.0,  // 100% autoevaluación (solo se autoevalúan)
