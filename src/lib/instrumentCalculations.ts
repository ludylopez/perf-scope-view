...
export const INSTRUMENT_CALCULATION_CONFIGS: Record<string, InstrumentCalculationConfig> = {
  ...
  D2: {
    ...
    calcularResultadoFinal: (desempenoAuto, desempenoJefe, potencial) => {
      // D2 usa pesos estándar: 30% autoevaluación + 70% jefe
      const desempenoFinal = Math.round((desempenoJefe * 0.7 + desempenoAuto * 0.3) * 100) / 100;
      return { desempenoFinal, potencial };
    },
    pesoJefe: 0.7, // Pesos estándar
  ...
  // Instrumento A4 - Administrativos II
  A4: {
    instrumentId: "A4",
    nivel: "A4",
    calcularDesempeno: (responses, dimensions) => {
    ...
    calcularResultadoFinal: (desempenoAuto, desempenoJefe, potencial) => {
      // A4 usa pesos estándar: 30% autoevaluación + 70% jefe
      const desempenoFinal = Math.round((desempenoJefe * 0.7 + desempenoAuto * 0.3) * 100) / 100;
      return { desempenoFinal, potencial };
    },
    pesoJefe: 0.7, // Pesos estándar
  ...
  // Instrumento S2 - Secretario Municipal
  S2: {
    instrumentId: "S2",
    nivel: "S2",
    calcularDesempeno: (responses, dimensions) => {
    ...
    calcularResultadoFinal: (desempenoAuto, desempenoJefe, potencial) => {
      // S2 usa pesos estándar: 30% autoevaluación + 70% jefe
      const desempenoFinal = Math.round((desempenoJefe * 0.7 + desempenoAuto * 0.3) * 100) / 100;
      return { desempenoFinal, potencial };
    },
    pesoJefe: 0.7, // Pesos estándar
  ...
  // Instrumento E2 - Encargados y Jefes de Unidades II
  E2: {
    instrumentId: "E2",
    nivel: "E2",
    calcularDesempeno: (responses, dimensions) => {
    ...
    calcularResultadoFinal: (desempenoAuto, desempenoJefe, potencial) => {
      // E2 usa pesos estándar: 30% autoevaluación + 70% jefe
      const desempenoFinal = Math.round((desempenoJefe * 0.7 + desempenoAuto * 0.3) * 100) / 100;
      return { desempenoFinal, potencial };
    },
    pesoJefe: 0.7, // Pesos estándar
  ...
  // Instrumento D1 - Gerente - Direcciones I
  D1: {
    instrumentId: "D1",
    nivel: "D1",
    calcularDesempeno: (responses, dimensions) => {
    ...
    calcularResultadoFinal: (desempenoAuto, desempenoJefe, potencial) => {
      // D1 usa pesos estándar: 30% autoevaluación + 70% jefe
      const desempenoFinal = Math.round((desempenoJefe * 0.7 + desempenoAuto * 0.3) * 100) / 100;
      return { desempenoFinal, potencial };
    },
    pesoJefe: 0.7, // Pesos estándar
